...
if __name__ == '__main__':  
    ...
    print '=============== nocode start train ==============='
    codes = TaggedLineDocument('test/nocode50904245.dat')
    codeModel = Doc2Vec(codes, min_count=1, dm=0, window=5, size=200, sample=1e-3, negative=5, workers=4)
    codeModel.save('test/nocodedoc50904245.model')
    print '=============== nocode end train ==============='
