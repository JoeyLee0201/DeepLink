...
sentences3 = word2vec.Text8Corpus("corpus1/nocode50904245.dat")
model3 = word2vec.Word2Vec(sentences3, size=VECTOR_SIZE, sg=1, hs=1,  iter=80)
model3.save("test/nocode50904245-4.model")
